...
module.exports = class TeslaOAuth2Driver extends OAuth2Driver {
  ...
  async registerDomain(){
    ...
    try{
      ...
      this.log("registerDomain() => Error NA domain registration: ",error.message);
      errorMessage = "Error NA domain registration: " + error.message;
    }
    ...
    try{
      ...
      this.log("registerDomain() => Error EU domain registration: ",error.message);
      if (errorMessage === ''){
        errorMessage = "Error EU domain registration: " + error.message;      
      }
      else{
        errorMessage = errorMessage + ', Error EU domain registration: ' + error.message;
      }
    }
